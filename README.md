...
The repos heres reflect the fact that, as a consultant, I mostly used React with AWS, especially AWS Amplify and its associated services: s3, Cognito, DynamoDB, AppSync, and Lambda. Today, I use Svelte more for my blog, which I talk about [here](https://javascriptpage.com/react-svelte-pitch-deck-app-comparison) on my [JavaScriptPage](https://javascriptpage.com) site. 
